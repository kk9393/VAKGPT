  ...
  return (
    <div className="">
      ...
      <section className="pt-6 pb-10 bg-gray-100">
        <div className="flex flex-col mx-auto rounded-2xl bg-white h-[70vh] w-[95vw] lg:w-[80vw]">
          ...
          <div className="flex items-center justify-center mt-6">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center px-4 py-2 bg-black border border-gray-300 rounded-full shadow-lg hover:bg-gray-950 transition"
            >
              <svg
                ...
                viewBox="0 0 20 20"
              >
                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.286 3.957a1 1 0 00.95.69h4.163c.969 0 1.371 1.24.588 1.81l-3.37 2.448a1 1 0 00-.364 1.118l1.286 3.957c.3.921-.755 1.688-1.54 1.118l-3.37-2.448a1 1 0 00-1.175 0l-3.37 2.448c-.784.57-1.838-.197-1.539-1.118l1.285-3.957a1 1 0 00-.364-1.118L2.07 9.384c-.783-.57-.38-1.81.588-1.81h4.163a1 1 0 00.95-.69l1.286-3.957z" />
              </svg>
